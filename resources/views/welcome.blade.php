        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="hero__categories">
                    ...
                    <ul>
                        <li><a href="category.html">Wedding Cakes</a></li>
                        <li><a href="#">Birthday Cakes</a></li>
                        <li><a href="#">Small Chops</a></li>
                        <li><a href="#">Queens Cake</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-9">
        ...
        <div class="container">
            <div class="row">
                <div class="categories__slider owl-carousel">
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="{{ asset('frontend/image/cupcakes.jpg') }}">
                            <h5><a href="#">CupCakes</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="{{ asset('frontend/image/meatpie.jpg') }}">
                            <h5><a href="#">MeatPie</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="{{ asset('frontend/image/sweetberry.jpg') }}">
                            <h5><a href="#">Raspberry cake</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="{{ asset('frontend/image/cake-ideas-13.jpg') }}">
                            <h5><a href="#">birthday Cake</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="{{ asset('frontend/image/wedding.jpeg') }}">
                            <h5><a href="category.html">wedding cake</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="{{ asset('frontend/image/sweetsnacks.jpg') }}">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="featured__controls">
                        <ul>
                            ...
                            <li data-filter=".oranges">Wedding Cake</li>
                            <li data-filter=".fresh-meat">Birthday Cake</li>
                            <li data-filter=".vegetables">Deserts</li>
                            <li data-filter=".fastfood">Small chops</li>
                        </ul>
                    </div>
                </div>
            </div>
